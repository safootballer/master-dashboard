  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(160deg, #000 0%, #050f05 30%, #050a0f 65%, #000 100%)',
      }} />
      {/* Glow blobs */}
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '3rem 1.5rem 4rem' }}>
        ...
        <div className="fade-up" style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '2rem', marginBottom: '1.5rem' }}>
            <img src="/logo2.png" alt="SAFie" style={{ height: 64, filter: 'drop-shadow(0 4px 12px rgba(44,163,238,0.4))' }}
              onError={() => {}} />
            <div style={{ width: 1, height: 64, background: 'rgba(44,163,238,0.2)' }} />
            <img src="/logo.png" alt="SA Footballer" style={{ height: 64, filter: 'drop-shadow(0 4px 12px rgba(255,255,255,0.15))' }}
              onError={() => {}} />
          </div>
            ...
            return (
              <a
                ...
                onMouseEnter={e => {
                  ...
                  el.style.borderColor = s.accentColor
                  el.style.transform = 'translateY(-6px)'
                  el.style.boxShadow = `0 20px 60px ${s.glowColor}, 0 8px 32px rgba(0,0,0,0.4)`
                }}
                onMouseLeave={e => {
                  const el = e.currentTarget
                  el.style.borderColor = 'rgba(44,163,238,0.2)'
              ...
              >
                <div>
                  {/* Icon */}
                  <div style={{ fontSize: '3rem', marginBottom: '1rem', display: 'block' }}>{s.icon}</div>
                  ...
                  <span style={{
                    ...
                    border: s.badgeBorder ? `1px solid ${s.badgeBorder}` : 'none',
                  }}>{s.badge}</span>
                ...
                <div style={{ marginTop: '1.5rem' }}>
                  <span style={{
                    ...
                    borderRadius: 50, border: s.btnStyle === 'green' || s.btnStyle === 'amber' ? `1.5px solid ${s.accentColor}` : 'none',
        ...
        <div style={{
          ...
          <p style={{ marginTop: '0.4rem' }}>
            Powered by <span style={{ color: '#2ca3ee', fontWeight: 700 }}>SAFie AI</span>
            {' · '}
